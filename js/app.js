...
let sliderReviews = new Swiper('.home', {
	//! Часто исп. настройки --------------------------------------------------------------
...
let sliderWorks = new Swiper('.works__body', {
	//! Часто исп. настройки --------------------------------------------------------------
	observer: true, //? Обнов. свайпер, при изм. эл. слайдера
	observeParents: true, //? Обнов. свайпер, при изм. род. эл. слайдера
	// observeSlideChildren: true, //? Обнов. свайпер при изм. дочерн. эл. слайда

	slidesPerView: 5.53, //? Кол. слайдов для показа (2.1, 2.2.. тоже работает)
	...
	//! Автопрокрутка --------------------------------------------------------------------------
	autoplay: {
		delay: 00, //? Пауза между прокруткой
		stopOnLastSlide: true, //? Закончить на последнем слайде
		disableOnInteraction: true //? Отключить после ручного переключения
	},
...
let sliderWorks2 = new Swiper('.works__body2', {
	//! Часто исп. настройки --------------------------------------------------------------
	observer: true, //? Обнов. свайпер, при изм. эл. слайдера
	observeParents: true, //? Обнов. свайпер, при изм. род. эл. слайдера
	// observeSlideChildren: true, //? Обнов. свайпер при изм. дочерн. эл. слайда
...
sliderWorks.controller.control = sliderWorks2; //? Передача управления myImageSlider - 1ый слайдер
sliderWorks2.controller.control = sliderWorks; //? Передача управления myTextSlider - 2ой слайдер

let sliderReviewsBottomTop = new Swiper('.reviews__top', {
	//! Часто исп. настройки --------------------------------------------------------------
	observer: true, //? Обнов. свайпер, при изм. эл. слайдера
	observeParents: true, //? Обнов. свайпер, при изм. род. эл. слайдера
	// observeSlideChildren: true, //? Обнов. свайпер при изм. дочерн. эл. слайда
